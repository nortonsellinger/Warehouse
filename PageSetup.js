...
var NAV_WIDTH;
var IMAGE_WIDTH;
var BASE_CONTENT_FONT_SIZE_COEFF = 0.012;
...
function PageSetup() {
    ...
    document.getElementById('content').style.setProperty('font-size', BASE_CONTENT_FONT_SIZE_COEFF * GreaterEdge + MinorEdge * 0.015 + 'px');
}
